...
public class AudioManager : MonoBehaviour
{
    ...
    public AudioClip Attack;          //The player jump sound effect

	[Header("Boss Audio")]
	public AudioClip bosswalking;
	public AudioClip attack1;
	public AudioClip attack2;
	public AudioClip roraar;
    ...
    //BOSS------------------------------------------------------------------------------
    public static void PlayAttack1Audio()
    {
        //If there is no current AudioManager, exit
        if (current == null)
            return;
        ...
        //Set the jump SFX clip and tell the source to play
        current.playerSource.clip = current.attack1;
        current.playerSource.Play();
    }

    public static void PlayAttack2Audio()
    {
        //If there is no current AudioManager, exit
        if (current == null)
            return;
        ...
        //Set the jump SFX clip and tell the source to play
        current.playerSource.clip = current.attack2;
        current.playerSource.Play();
    }

    public static void PlayBoosWalkAudio()
    {
        //If there is no current AudioManager, exit
        if (current == null)
            return;
        ...
        //Set the jump SFX clip and tell the source to play
        current.playerSource.clip = current.bosswalking;
        current.playerSource.Play();
    }

    public static void PlayBoosWroarAudio()
    {
        //If there is no current AudioManager, exit
        if (current == null)
            return;
        ...
        //Set the jump SFX clip and tell the source to play
        current.playerSource.clip = current.roraar;
        current.playerSource.Play();
    }

    public static void PlayBooshurtAudio()
    {
        //If there is no current AudioManager, exit
        if (current == null)
            return;
        ...
        //Set the jump SFX clip and tell the source to play
        current.playerSource.clip = current.hurt;
        current.playerSource.Play();
    }

    public static void PlayBoosdieAudio()
    {
        //If there is no current AudioManager, exit
        if (current == null)
            return;
        ...
        //Set the jump SFX clip and tell the source to play
        current.playerSource.clip = current.die;
        current.playerSource.Play();
    }

    public static void PlaypipAttackAudio()
    {
        //If there is no current AudioManager, exit
        if (current == null)
            return;
        ...
        //Set the jump SFX clip and tell the source to play
        current.playerSource.clip = current.Attack;
        current.playerSource.Play();
    }
